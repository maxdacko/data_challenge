...
def calculate_next_payment_day_sum_week(row):
    """
    Same as before but adding a week to the next payment day if it falls within the same week.
    Args:
    ...
    if next_date.isocalendar()[1] == timestamp.isocalendar()[1]:
